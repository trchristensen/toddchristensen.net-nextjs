...
export default function LRProjectCard({ title, description, href, icon }) {
  return (
    <a
    ...
    >
      <div className="flex items-center border border-base-200 text-base-content rounded p-4">
          
        {icon == "react2025" && (
          <div className="h-8 w-8 ml-2 mr-4">
            <span className="sr-only">React 2025</span>
            <svg
              className="h-8 w-8 min-w-sm"
              viewBox="0 0 267 305"
            >
              <g fill="currentColor">
