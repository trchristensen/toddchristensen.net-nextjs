...
function SectionTitle(props) {
  return (
    <p
      className="col-span-2 pt-8 text-lg font-extrabold md:font-normal md:text-base md:pt-0 md:text-right md:text-opacity-40"
      {...props}
    />
  );
}
...
function TableRow({ href, title, subtitle, date }: TableRowProps) {
  return (
    ...
    >
      <span className="flex-none font-medium group-hover:underline group-hover:text-blue-600 dark:group-hover:text-blue-500">
        {title}
      </span>
      <span className="flex-shrink w-full border-t border-base-300 border-dashed" />
