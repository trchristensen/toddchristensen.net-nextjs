  ...
  return (
    <>
      <div
        ...
        className={`sticky top-0 z-10 flex justify-center flex-col px-3 py-2 bg-opacity-80 bg-base-200  filter-blur border-b-base-300`}
      >
          ...
          <span className="flex items-center space-x-3">
            {globalMenu && (
              <span
                ...
                className="flex items-center justify-center p-2 rounded-md cursor-pointer lg:hidden"
              >
                {isOpen ? (
